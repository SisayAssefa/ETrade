...
<style>
    ...
    #tblMyWatchListView tbody tr:nth-child(even) {
        background: #d4e1b3;
    }

    #tblMyWatchListView tbody tr:nth-child(odd) {
        background: #fff;
    }
        ...
        <thead>
            <tr>
                ...
                <th class="buyColumnHeader">
                    <asp:Label ID="lblBidQty" runat="server" Text="<%$ Resources:Resource, lblBidQty %>"></asp:Label></th>
                <th class="buyColumnHeader">
                    <asp:Label ID="lblBidPrice" runat="server" Text="<%$ Resources:Resource, lblBidPrice %>"></asp:Label></th>
                <th class="sellColumnHeader">
                    <asp:Label ID="lblAskPrice" runat="server" Text="<%$ Resources:Resource, lblAskPrice %>"></asp:Label></th>
                <th class="sellColumnHeader">
                    <asp:Label ID="lblAskQty" runat="server" Text="<%$ Resources:Resource, lblAskQty %>"></asp:Label></th>
                <th class="thPriceInfo">
                    <asp:Label ID="lblLast" runat="server" Text="<%$ Resources:Resource, lblLast %>"></asp:Label></th>
                <th class="thPriceInfo">
                    <asp:Label ID="lblHigh" runat="server" Text="<%$ Resources:Resource, lblHigh %>"></asp:Label></th>
                <th class="thPriceInfo">
                    <asp:Label ID="lblLow" runat="server" Text="<%$ Resources:Resource, lblLow %>"></asp:Label></th>
                <th class="thPriceInfo">
                    <asp:Label ID="lblOpen" runat="server" Text="<%$ Resources:Resource, lblOpening %>"></asp:Label></th>
                <th class="thPriceInfo">
                    <asp:Label ID="lblVolume" runat="server" Text="<%$ Resources:Resource, lblVolume %>"></asp:Label></th>
                <th class="thPriceInfo">
                    <asp:Label ID="lblChange" runat="server" Text="<%$ Resources:Resource, lblChange %>"></asp:Label></th>
...
<script type='text/javascript'>
    ...
    function PopulateTicketInformation(_symbol, _warehouse, _year, _bidQty, _bidPrice, _askQty, _askPrice) {
        ...
        sCombo.val(_symbol);//.trigger('change'); //sCombo.select2("val", _symbol);

        var wCombo = $("#_drpWarehouse");
        wCombo.append($('<option></option>').val(_warehouse).html(_warehouse));
        wCombo.val(_warehouse)//.trigger('change'); //wCombo.select2("val", _warehouse);

        var pCombo = $("#_drpProductionYear");
        pCombo.append($('<option></option>').val(_year).html(_year));
        pCombo.val(_year)//.trigger('change'); //pCombo.select2("val", _year);

        var qText = $("#_txtQuantity");
        var pText = $("#_txtLimitPrice");
        $("#_drpSymbol").prop('disabled', true); //.select2("enable", false);
        $("#_drpWarehouse").prop('disabled', true); //.select2("enable", false);
        $("#_drpProductionYear").prop('disabled', true); //.select2("enable", false);
        $("#_drpSession").prop('disabled', true); //.select2("enable", false);

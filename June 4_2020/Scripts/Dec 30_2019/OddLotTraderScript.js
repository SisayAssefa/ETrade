    ...
    $('#lnkConfirmSubmitOddLot').on('click', function () {
        ...
        if (_selectedOption == 1 || _selectedOption == 2) {
            ...
            if (_selectedOption == 2)
                if ($("#_drpClientOddLot").val() == '') {//$("#_drpClientOddLot").select2("val") == "") {
...
function TradeOwnerToggle() {
    ...
    $('input:radio[name=buyFor]').bind("change", function () {
        ...
        if (_selectedOption == 1) {
            $("#_drpClientOddLot").prop('disabled', true); //.select2("enable", false);
            $("#_drpClientOddLot").val('').trigger('change'); //.select2("val", "");
            $("#tdTradeOwner").css("border", "none");
            ...
            $("#_drpClientOddLot").prop('disabled', false); //.select2("enable", true);
            $("#tdTradeOwner").css("border", "none");
            $('#spnClientNameHolderOddLot').html('');
        }
        else {
...
function ClientDropdownChanged() {
    $("#_drpClientOddLot").bind("change", function () {
        ...
        var _clientIdNo = $.trim($("#_drpClientOddLot option:selected").text()); //$("#_drpClientOddLot").select2("data").text);
        if (_clientIdNo == "") {
            $("#spnClientNameHolderOddLot").html('');
            return;
        }
...
function InitializeOddLotOrder() {
    ...
    var _userNumber = _isSelfTrade ? userInformation.MemberInfo.IDNO : /*"00000000-0000-0000-0000-000000000000";*/$("#_drpClientOddLot option:selected").text(); //$("#_drpClientOddLot").select2("data").text;

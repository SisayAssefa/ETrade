        ...
        <table id="tblTradeHistory" class="table table-striped table-bordered table-condensed">
            <thead>
                <tr>
                    ...
                    <th><asp:Label ID="Label13" runat="server" Text="<%$ Resources:Resource, lblBuySell %>"></asp:Label></th>
                    <th><asp:Label ID="Label19" runat="server" Text="<%$ Resources:Resource, lblStatus %>"></asp:Label></th>
                    <th> <asp:Label ID="Label16" runat="server" Text="<%$ Resources:Resource, lblMemberId %>"></asp:Label></th>
                    <th> <asp:Label ID="Label15" runat="server" Text="<%$ Resources:Resource, lblDate %>"></asp:Label></th>
                    <%--<th>
                        <asp:Label ID="Label4" runat="server" Text="<%$ Resources:Resource, lblClientId %>"></asp:Label></th>--%>
                    <th><asp:Label ID="Label18" runat="server" Text="<%$ Resources:Resource, lblRep %>"></asp:Label></th>
                </tr>
            </thead>

<%@ Page Title="Instruction Histroy Details View" Language="C#" MasterPageFile="~/TraderFlatMasterPage.Master" AutoEventWireup="true" CodeBehind="InstructionHistorysDetailView.aspx.cs" Inherits="TraderUI.InstructionHistorysDetailView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainMasterContent" runat="server">
    <div>
        
        <h2>Instruction Change History </h2>
                  ...
                  <asp:UpdatePanel runat="server" ID="OrderChangeHistUpdatePanel">
                    <ContentTemplate>
                        <asp:HiddenField ID="hiddnIbNo" runat="server" />
                         <asp:ListView ID="lsvInstructionChangeHistorys" runat="server" ClientIDMode="Static" DataKeyNames="Id" OnLoad="lsvInstructionChangeHistorys_Load">
                        <LayoutTemplate>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td><span title="Instruction Id"><%# Eval("OrderId") %></span></td>

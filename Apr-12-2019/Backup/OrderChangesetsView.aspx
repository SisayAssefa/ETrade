<%@ Page Title="Change Set View" Language="C#" MasterPageFile="~/TraderFlatMasterPage.Master" AutoEventWireup="true" CodeBehind="OrderChangesetsView.aspx.cs" Inherits="TraderUI.OrderChangesetsView" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainMasterContent" runat="server">
    <script>
        function ViewChangeSetDetail(OrderID) {
            var j = jQuery.noConflict();
            var serviceUrl = serviceUrlHostName + 'Order_svc.svc/GetOrderChangeSetDetailByID';
            var count = 0;
            var resultCount = 0;
            var parameter = { changeSetID: OrderID };
            var comboId = '';
            j.ajax({
                type: "post",
                url: serviceUrl,
        ...
        <div id="divOrderChageSets">
            ...
            <asp:UpdatePanel runat="server" ID="OrderChangeSetsUpdatePanel">
                <ContentTemplate>
                    ...
                    <asp:ListView ID="lsvOrderChangeSets" runat="server" ClientIDMode="Static" DataKeyNames="Id" OnLoad="lsvOrderChangeSets_Load">
                        <LayoutTemplate>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td>
                                    <asp:Button ID="Button1" ToolTip="View Detail" Text='<%# Eval("OrderIDNo") %>' CssClass="btn btn-link" OnClientClick="ViewChangeSetDetail($('#idFiled').val());" runat="server" />
                        ...
                        <EmptyDataTemplate>
                            <table>
                                <tr>
                                    <td><strong>No order change set to display!</strong></td>
                                </tr>
                            </table>
                        </EmptyDataTemplate>
                        <EditItemTemplate>

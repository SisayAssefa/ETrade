...
var cashBalanceApiUrl = 'http://10.1.17.21:5004/api/CashBalance/GetBalance?';//'ttp://10.1.12.162:5002/DataWebApi/api/CashBalance/GetBalance?';
var cashBalanceApi_ClientUrl = 'http://10.1.17.21:5004/api/CashBalance/GetBalanceForClient?';
        ...
        success: function (data) {
            if (data != null && data.length > 0) {
                ...
                $.each(data, function (idx) {
                    ...
                    var roundedTempQty = (this.TempQuantity*LotInQuintal).toFixed(4);
                    ...
                    var roundedInitQty = (this.CurrentQuantity*LotInQuintal).toFixed(4);

    ...
    <div id="sellBuyFormContent" style="font-size: 14px">
        <table id="orderTable">
            ...
            <tr class="toBeHiddenOnOddLot">
                ...
                <td>
                    <%-- onchange="MarketOrderToggle()"--%>
                    <input type="checkbox" id="chkIsMarketOrder" class="toBeDisabledOnOddLot" onchange="MarketOrderToggle()"  disabled="disabled" hidden="hidden" readonly="readonly"  /><asp:Label ID="chkOrderType"  runat="server" Text="<%$ Resources:Resource, chkOrderType %>" Visible="False"></asp:Label>
                </td>
            </tr>
            <tr>
                <td><span>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="toBeHiddenOnOddLot">
                        <input type="radio" name="optionValidity" class="radioGroupValidity" id="_radTillCancelValidity" value="2" disabled /><span style="width: 25px;"><asp:Label ID="lblGtcValidity" runat="server" Text="<%$ Resources:Resource, lblGtcValidity %>" Font-Size="9pt"></asp:Label></span>
                        <input type="radio" name="optionValidity" class="radioGroupValidity" id="_radTillDateValidity" value="3" disabled/><span style="width: 25px;"><asp:Label ID="lblGtdValidity" runat="server" Text="<%$ Resources:Resource, lblGtdValidity %>" Font-Size="9pt"></asp:Label></span>
                    </span></td>
            </tr>
            ...
            <div id="multipleOrderBody" class="modal-body">
                ...
                <div id="commonInfoSection2" class="hidden form-horizontal">
                    <div class="form-group" style="clear: both;">
                        ...
                        <div class="span8">
                            <input type="checkbox" id="chkIsMultipleMarketOrder" onchange="MultipleMarketOrderToggle()" disabled="disabled" readonly="readonly"  hidden="hidden"/><%--style="margin: 0px 0px 0px 20px;"--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="span8">
                            ...
                            <input type="radio" name="optionValidityMulti" class="radioGroupValidity" id="_radMultipleTillCancelValidity" value="2" disabled="disabled" /><span style="width: 25px;"><asp:Label ID="Label17" runat="server" Text="<%$ Resources:Resource, lblGtcValidity %>" Font-Size="9pt"></asp:Label></span>
                            <input type="radio" name="optionValidityMulti" class="radioGroupValidity" id="_radMultipleTillDateValidity" value="3" disabled="disabled" /><span style="width: 25px;"><asp:Label ID="Label18" runat="server" Text="<%$ Resources:Resource, lblGtdValidity %>" Font-Size="9pt"></asp:Label></span>

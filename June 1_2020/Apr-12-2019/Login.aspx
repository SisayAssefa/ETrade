...
<head runat="server">
    ...
    <style>
        #divLogin {
            ...
            border-radius: 8px;
            -moz-box-shadow: 3px 3px 2px #f8d64f;
            -webkit-box-shadow: 3px 3px 2px #f8d64f;
            box-shadow: 3px 3px 2px #f8d64f;
            border: 2px solid #89ac2e;
        ...
        .loginTextboxStyle {
            -moz-box-shadow: 1px 1px 0px #3E8674;
            -webkit-box-shadow: 1px 1px 0px #3E8674;
...
<body onload="focusUserNameControl();">
    <form id="form1" runat="server" autocomplete="off">
        ...
        <div id="divLogin" style="clear: both; background: url('Images/loginBackground.png'); background-repeat: no-repeat; background-position: center;">
            <section style="width: 100%; margin-top: 5px; text-align: center; font-size: large; background: #89AC2E; color: #fff;"><span>
                <asp:Label ID="labelTitle" runat="server" Text="<%$ Resources:Resource, lblLoginTitle %>"></asp:Label></span> </section>
            ...
            <asp:Login ID="Login1" runat="server" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#333333" OnAuthenticate="Login1_Authenticate" Width="100%" Height="100%" OnLoggedIn="Login1_LoggedIn" OnLoginError="Login1_LoginError" OnInit="Login1_Init" DestinationPageUrl="~/Dashboard.aspx">
                    ...
                    <table id="loginTable" style="width: 100%; border-collapse: collapse; top: 0px;">
                        ...
                        <tr>
                            <td style="text-align: center;" colspan="2">
                                <asp:Button ID="LoginButton" runat="server" BackColor="White" BorderColor="#C5BBAF" BorderStyle="Solid" BorderWidth="1px" CommandName="Login" Font-Names="Verdana" Font-Size="1em" ForeColor="#86a23d" Text="Log In" ValidationGroup="Login1" Font-Bold="True" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">

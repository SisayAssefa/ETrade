...
<div id="divPositionSummary">
    ...
    <table style="width: 100%; background: #efeff2; -webkit-border-top-left-radius: 10px; border-top-left-radius: 10px; -webkit-border-top-right-radius: 10px; border-top-right-radius: 10px;">
        <tr>
            <td colspan="2">
                <h4>
    ...
    <table style="width: 100%;" id="positionSummaryContainer">
        ...
        <tr>
            <td colspan="2">
                <section>
                    <h5>
                        <asp:Label ID="lblBankBalance" runat="server" Text="<%$ Resources:Resource, BankBalance %>"></asp:Label>
                        <a class="icon icon-refresh" href="#" style="margin-left: 10px;" id="rfsBtn" onclick="populateBankBalance();" title="Refresh"></a>
                    </h5>
                    <section id="divMemberBankBalanceInfo" title="Member Balance" style="display: none;">
                                            ...
                                            <thead>
                                                <tr class="brow">
                                                    ...
                                                    <th style="text-align: right;">
                                                        <asp:Label ID="lblMemberTotalDeducted" runat="server" Text="<%$ Resources:Resource, lblTotalDeducted %>"></asp:Label></th>
                                                </tr>
                                            </thead>
                                        </table>
                                        ...
                                        <table class="dataTable">
                                            <thead>
                                                <tr class="brow">
                                                    ...
                                                    <th style="text-align: right;">
                                                        <asp:Label ID="lblClientTotalDeducted" runat="server" Text="<%$ Resources:Resource, lblTotalDeducted %>"></asp:Label></th>
                        ...
                        <section id="divClientBankAccountSelf" style="display: none;">
                            <table class="dataTable">
                                <thead>
                                    <tr class="brow">
                                        <th>
                                        ...
                                        <th style="text-align: right;">
                                            <asp:Label ID="lblSelfClientTotalDeducted" runat="server" Text="<%$ Resources:Resource, lblTotalDeducted %>"></asp:Label></th>
        ...
        <tr>
            <td colspan="2">
                <section id="divClientBankBalanceInfoContainer" style="display: none;">
                    <h5>
                        <asp:Label ID="ClientsBankBalance" runat="server" Text="<%$ Resources:Resource, ClientsBankBalance %>"></asp:Label>
                    </h5>
        ...
        <tr>
            <td colspan="2">
                <section id="divWRInfoContainer" style="display: none;">
                    <h5>
                        <asp:Label ID="lblWarehouseReceipts" runat="server" Text="<%$ Resources:Resource, WarehouseReceipts %>"></asp:Label>
                        <a class="icon icon-refresh" href="#" style="margin-left: 10px;" onclick="populateWarehouseReceipts();" title="Refresh"></a>
                    </h5>

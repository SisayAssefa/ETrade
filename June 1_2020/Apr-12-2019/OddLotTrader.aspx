        ...
        <section id="ticketConfirmationPopupOddLot" class="modal hide fade" style="border: 4px solid #ccc;">
            ...
            <section class="modal-body" style="border-top: 4px solid #ccc;">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td><span>
                            <asp:Label ID="lblClientId0" runat="server" Text="<%$ Resources:Resource, lblTradeFor %>"></asp:Label></span></td>
                        <td><span style="float: left;" id="spnClientOddLot"></span><span style="float: left; margin-left: 2px; background: #89ac2e; color: #fff; border: 2px dotted #89ac2e; -moz-border-radius: 2px; -webkit-border-radius: 2px; border-radius: 2px;"
                            id="spnClientNameHolderOddLot"></span></td>
                    </tr>
                    <tr>
                        <td><span>

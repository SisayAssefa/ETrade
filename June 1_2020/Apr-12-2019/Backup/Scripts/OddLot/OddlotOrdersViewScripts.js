...
function EditPendingOrder(Id, rowNumber) {
    ...
    htmlInput = '<input type="text" class="inputEditPending"  id="editOddLotOrderPrice" value="' + ItemPrice.trim() + '" /><span visible="true" style="Color:Red"  id="errorEditOrderPrice"></span>';

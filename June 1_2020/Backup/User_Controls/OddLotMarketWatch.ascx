...
<div style="margin-top:3px;">    
    ...
    <select id="drSessionMW" onchange="filterOddLotMarketWatch('session', this.value)" style="min-width: 160px; max-width: 160px; box-shadow: 0px 0px 4px #FAA52C; border: medium none;">
    </select>
</div>

                        ...
                        $(self).find("td:first").each(function () {
                            if (data.indexOf($(this).text()) == -1) {
                                ...
                                if ($(self).find("td").length == 13) {
                                    ...
                                    $(self).append("<td><a href='#' style='color:red;' title='Add to chart' onclick='GetVisualizationByContract(this); return false;'><img src='Images/chart_line_add.png' alt='Remove' /></a></td>");
                                }
                            }
                        });
                    }

    ...
    j.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.GetDepthResult, function () {
                var bqty = '' + Number(Math.round((Number(Math.round(this.BuyerQty + 'e4') + 'e-4') * LotInQuintal) + 'e4') + 'e-4');
                //var testnum = Number(Math.round(bqty + 'e4') + 'e-4');
                var bAggqty = '' + Number(Math.round((Number(Math.round(this.BuyerAgregateQty + 'e4') + 'e-4') * LotInQuintal) + 'e4') + 'e-4');
                var bprice = '' + this.BuyerPrice;
                var sqty = '' + Number(Math.round((Number(Math.round(this.SellQty + 'e4') + 'e-4') * LotInQuintal) + 'e4') + 'e-4');
                var sAggqty = '' + Number(Math.round((Number(Math.round(this.SellAgregateQty + 'e4') + 'e-4') * LotInQuintal)+ 'e4') + 'e-4');
                ...
                /*Orignal Code before implementing market depth obsification
                if (displaybuyerId) {
                ...
                html += "<td style='text-align:center'>" + (Number(Math.round((Number(Math.round(this.BuyerAgregateQty + 'e4') + 'e-4')* LotInQuintal)+ 'e4') + 'e-4')) + "</td> ";
                ...
                html += "<td style='text-align:center' >" + (Number(Math.round((Number(Math.round(this.SellAgregateQty + 'e4') + 'e-4') * LotInQuintal) + 'e4') + 'e-4')) + "</td> "; 
                ...
                /*Newly added code for Market depth obsification*/
                var x = 0;
                if (displaybuyerId) {
                    html += "<td style='text-align:center'> " + this.BuyerID + "</td> ";

                    html += "<td style='text-align:center'>" + (this.BuyerAgregateQty * LotInQuintal).toFixed(4) + "</td> ";
                    html += "<td class='buyColumn'  style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 0 + " , " + bpriceParam + " ," + bqtyParam + "," + x + "," + x + ")' >" + bqty + ' ' + bFillTypeName + "</td> ";
                    html += "<td class='buyColumn'  style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 0 + " , " + bpriceParam + " ," + bqtyParam + "," + x + "," + x + ")' >" + bprice + "</td> ";
                }
                else {
                    html += "<td style='text-align:center'>********</td> ";

                    html += "<td style='text-align:center'>********</td> ";
                    html += "<td class='buyColumn'  style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 0 + "," + x + "," + x + "," + x + "," + x + " )' >********</td> ";
                    html += "<td class='buyColumn'  style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 0 + "," + x + "," + x + "," + x + "," + x + ")' >********</td> ";
                }
                if (displaySellerId) {
                    html += "<td class='sellColumn' style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 1 + "," + x + "," + x + ", " + spriceParam + " , " + sqtyParam + ")' >" + sprice + "</td> ";
                    html += "<td class='sellColumn' style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 1 + "," + x + "," + x + ", " + spriceParam + " , " + sqtyParam + ")' >" + sqty + sFillTypeName + "</td> ";
                    html += "<td style='text-align:center' >" + (this.SellAgregateQty * LotInQuintal).toFixed(4) + "</td> ";
                    html += "<td style='text-align:center' >" + this.SellerID + "</td> ";
                }
                else {
                    html += "<td class='sellColumn' style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 1 + "," + x + "," + x + "," + x + "," + x + ")' >********</td> ";
                    html += "<td class='sellColumn' style='text-align:center' onClick='populateOrderEnrtyFromDepth(" + 1 + "," + x + "," + x + "," + x + "," + x + ") '>********" + sFillTypeName + "</td> ";
                    html += "<td style='text-align:center' >********</td> ";
                    html += "<td style='text-align:center'>********</td> ";

                }
                /*End of newly added code for market depth obsification*/

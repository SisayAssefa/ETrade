...
function InitializeOrderEntry() {
    try {
        ...
        var _quantity = ($("#_txtQuantity").val() / LotInQuintal).toFixed(4);
...
function RessetOrderEntryForm() {
    ...
    $("#_txtQuantity").prop('disabled', false);
...
function PopulateOddLotWarehouseReceipts() {
    ...
    if ($.trim(_clientId) == "")
        ...
        _clientId = userInformation.MemberInfo != null ? userInformation.MemberInfo.MemberId : userInformation.ClientInfo.ClientID;
...
function GetRemainingCommodityBalanceForEdit(_userGuid, _symbol, _warehouse, _year) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            RemainingForContract = parseFloat(data);
            if (data < 0)
                data = 0;

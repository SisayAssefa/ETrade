...
handleF5Key = function (e) {
    var f5Pressed = false;
    if (e.altKey || e.ctrlKey || e.shiftKey || e.which == 3 || e.which == 2 || e.which == 123) {
        return false;
    }
    if (e.which == 17 || e.which == 116 || e.which == 3 || e.which==2 || e.which==123) {//Ctrl or F5 or right click or F12 is pressed/down
        if (e.which == 17)
            pressedKey = 'Ctrl';
        /*else if (e.which == 123)
            pressedKey = 'F12';
        else if (e.which == 3)
            pressedKey = 'Mouse Right Click';*/
        else if (e.which == 116) {
            pressedKey = "F5";
            f5Pressed = true;
        }
